...
const[loading,setLoading] = useState(false);
  ...
  const calculateBeer =   () => {
    debugger;
    setLoading(true)
     weatherService.getBeersBoxAndWheather(selectedDate,cantidadPersonas).then((data) =>{
      setLoading(false);
      debugger;
 ...
 error ={  selectedDate !== null && selectedDate.toDateString() !== "Invalid Date" ? false : true }
          maxDate={fechaMax} 
 ...
 onClick={calculateBeer}
    margin="normal"
        variant="contained"
        color="primary"
        disabled ={  cantidadPersonas > 0 && selectedDate !== null && selectedDate.toDateString() !== "Invalid Date" ? false : true }
        endIcon={<Icon></Icon>}
      >
         Calcular
 ...
 <Card variant="outlined">
        ...
        <Grid item xs={12}>
          ...
          <Grid container>
            {selectedDate !== null && selectedDate.toDateString() !== "Invalid Date" ? 
                  <Typography variant="h5" component="h2">
                  Temperatura para el dia {selectedDate.toLocaleDateString()}
                </Typography>
            : ''}
       <Grid item xs={12}>        
